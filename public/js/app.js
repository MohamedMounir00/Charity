...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_socket_io__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_socket_io___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_socket_io__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(25);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_socket_io___default.a, __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()(':6999'));
window.axios = __webpack_require__(69);
...
Vue.component('Message', __webpack_require__(53));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        sendMesaage: function sendMesaage() {
            axios.post('/sendMessage', { name: this.name, body: this.message, phone: this.phone }).then(function (response) {
                ...
                return _c("div", { key: message.id, staticClass: "media" }, [
                  _c("div", { staticClass: "media-body" }, [
                    _c("p", [
                      ...
                      _c("span", [_vm._v(_vm._s(message.phone))])
                    ])
                  ])
                ])
              })
            )
          : _c("div", { staticClass: "messages-not-found" }, [
              _vm._v("Messages not found")
            ])
      ]),
      _vm._v(" "),
            ...
            _c(
              ...
              [
                _c("input", {
                  ...
                  attrs: { type: "text", placeholder: "type your chat" },
